...
use TMCms\Admin\Structure\Object\StructurePagePermissionCollection;
use TMCms\Admin\Users\Entity\AdminUserGroup;
use TMCms\Admin\Users\Object\GroupAccess;
use TMCms\Admin\Users\Object\GroupAccessCollection;
...
class Users
{
    ...
    public function checkSitePagePermissions($page_id, $action)
    {
        ...
        if (!self::$_structure_permissions) {
            ...
            $structure_pages = new StructurePagePermissionCollection();
