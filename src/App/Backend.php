...
class Backend
{
    ...
    private function parseUrl()
    {
        ...
        if ((!$url = parse_url(SELF)) || !isset($url['path'])) {
            return Response::getInstance()->setHtml('URL can not be parsed')->setFinished(true);
        }
...
//            'modules',
        ...
        if ($user_logged_in):
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">
                        <?= $menu->getPageTitle() ?>
                        <small><?= $menu->getPageDescription() ?></small>
                    </h3>
    ...
    {
        return (string)Response::getInstance();
    }
}